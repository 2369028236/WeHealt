...
public class QiNiuUtils {
    private static final String ACCESSKEY = "pOH1oBb8WzImp4l9_dk1owBXp4F5yec9G3IjuiHI";
    private static final String SECRETKEY = "hQKkJU2E3hK_I-cvz6E3EmLhJLSeaZrUKErlqfea";
    private static final String BUCKET = "we-health";
    public static final String DOMAIN= "http://qfhy5itom.hn-bkt.clouddn.com/";
    public static void main(String[] args) {
        uploadFile("E:/IdeaProjects/health_parent/health_web/src/main/webapp/img/avatar.png","dd2.jpg");
